...
var _              = require('lodash'),
    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            watch: {
                sass: {
                  files: ['content/themes/iceberg/assets/sass/*.scss'],
                  tasks: ['sass']
                },
                livereload: {
                    files: [
                        'content/themes/iceberg/assets/css/*.css',
                        'content/themes/iceberg/assets/js/*.js',
                        'core/client/dist/*.js',
            ...
            sass: {  
                dist: {
                    files: {
                        'content/themes/iceberg/assets/css/style.css': 'content/themes/iceberg/assets/sass/style.scss'
                    }
                }
            },
        ...
        grunt.registerTask('dev', 'Dev Mode; watch files and restart server on changes',
           ['bgShell:ember', 'express:dev', 'watch', 'sass']);
